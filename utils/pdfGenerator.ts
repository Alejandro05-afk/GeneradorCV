    ...
    <head>
      ...
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 1.5; color: #333; background: #fff; padding: 40px; }
        .header { border-bottom: 2px solid #C8102E; padding-bottom: 16px; margin-bottom: 24px; }
        .name { font-size: 28px; font-weight: bold; color: #C8102E; margin-bottom: 8px; }
        .contact-info { color: #666; font-size: 12px; }
        .contact-info div { margin-bottom: 2px; }
        .section { margin-bottom: 24px; }
        .section-title { font-size: 14px; font-weight: bold; color: #C8102E; margin-bottom: 12px; letter-spacing: 1px; }
        .summary-text { font-size: 12px; color: #444; text-align: justify; }
        .item { margin-bottom: 16px; padding-bottom: 12px; border-bottom: 1px solid #eee; }
        ...
        .skill-item { display: flex; align-items: center; background: #f5f5f5; padding: 6px 10px; border-radius: 4px; margin-right: 8px; margin-bottom: 8px; }
        .skill-name { font-size: 11px; font-weight: 600; color: #333; margin-right: 6px; }
        .skill-badge { font-size: 9px; font-weight: bold; color: #fff; padding: 2px 5px; border-radius: 3px; }
      </style>
    </head>
    <body>
      <div class="header">
